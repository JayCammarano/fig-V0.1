...
release1 = Release.create(release_type: "EP", title: "A Cool Tune", description: "Wow. I love this record. So Cool! Here is its history!", artist: [artist1], original_release_year: 1997, label: [label1], tag_id: [tag1])
